...
// Create the CommonJS version of the server
const serverContent = `// THIS FILE IS AUTO-GENERATED - DO NOT EDIT DIRECTLY
...
// Write the file
const outputPath = path.join(__dirname, "..", "server", "server-minimal.cjs");
fs.writeFileSync(outputPath, serverContent, "utf8");

console.log(`Generated CommonJS server at: ${outputPath}`);
